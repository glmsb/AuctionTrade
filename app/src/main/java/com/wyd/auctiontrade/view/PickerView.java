...
public class PickerView extends View {
    ...
    private List<PickerViewData> mDataList;
    /**
    ...
    public void setData(List<PickerViewData> items) {
        mDataList = items;
        mCurrentSelected = items.size() / 2;
        invalidate();
    }

    public PickerViewData getSelected() {
    ...
    private void moveHeadToTail() {
        if (mCurrentSelected == mDataList.size() - 1) {
            PickerViewData head = mDataList.get(0);
            mDataList.remove(0);
            mDataList.add(head);
        } else {
            mCurrentSelected++;
    ...
    private void moveTailToHead() {
        PickerViewData tail = mDataList.get(mDataList.size() - 1);
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        mMinTextSize = mMaxTextSize / 1.4f;
        isInit = true;
        invalidate();
    }
...
//            moveHeadToTail();
    ...
    public interface onSelectListener {
        void onSelect(PickerViewData data);
    }
