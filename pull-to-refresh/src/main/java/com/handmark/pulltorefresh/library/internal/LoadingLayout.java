...
public abstract class LoadingLayout extends FrameLayout implements
	...
	protected final ImageView mHeaderRefreshImage;
	...
	public LoadingLayout(Context context, final Mode mode,
		...
		mHeaderRefreshImage = (ImageView) mInnerLayout
				.findViewById(R.id.pull_to_refreshing_image);
	...
	public final void showInvisibleViews() {
		...
		if (View.INVISIBLE == mHeaderRefreshImage.getVisibility()) {
